...
const listCoins = async (): Promise<processedCoinList> => {
...
// Platform name map
const platformNameMap: nameMapType = {
    "polygon-pos": 'polygon',
    "harmony-shard-0": 'harmony'
}

const processCoinsList = (coinsList: Array<coinList>): processedCoinList => {
...
const getCoinHistory = async (token: string, currency='eur', days=365): Promise<coinHistory> => {
...
const getTokenPriceAtDate = (tokenHistory: coinHistory, dateStr: string): number | undefined => {
